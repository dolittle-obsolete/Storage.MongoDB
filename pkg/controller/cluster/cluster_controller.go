...
import (
	...
	mongodbv1 "dolittle.io/platform/storage/mongodb/pkg/apis/mongodb/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &mongodbv1.Cluster{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *mongodbv1.Cluster) *corev1.Pod {
